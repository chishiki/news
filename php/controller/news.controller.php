...
final class NewsMainController {
	...
	public function setState() {
		...
		// /news/update/<newsID>/
		if ($loc[3] == 'update' && is_numeric($loc[3]) && isset($input['news-update'])) {
		...
		// /news/delete/<newsID>/
		if ($loc[3] == 'delete' && is_numeric($loc[3]) && isset($input['news-delete'])) {
